...
fun main(args: Array<String>) {
    ...
    ).default(false) // TODO not implemented; using sandboxed PhoneBook pojo
    ...
    App.SEARCH_REPS = searchReps // tODO inv use delegate on parser option
    ...
    // tODO Jsonmode not implemeneted/passed; relocate plaintext phonebook entry there when ready
